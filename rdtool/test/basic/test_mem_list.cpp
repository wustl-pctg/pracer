...
// doesn't work for clang; no such pragma / attribute
...
int main(int argc, char* argv[]) {
  ...
  switch(which) {
    ...
    {
      int x = 0, y = 0, z = 0;
      x = cilk_spawn read_x_bytes(&data[0], 8);
      y = cilk_spawn read_x_bytes(&data[0], 4);
      z = cilk_spawn read_x_bytes(&data[4], 4);
      write_x_bytes(&data[0], 8);
      cilk_sync;
      global = x + y + z;
      assert(__cilksan_error_count() == 1);
    ...
    {
      int x = 0, y = 0, z = 0; 
      x = cilk_spawn read_x_bytes(&data[0], 4);
      y = cilk_spawn read_x_bytes(&data[4], 4);
      z = cilk_spawn read_x_bytes(&data[0], 8);
      write_x_bytes(&data[0], 8);
      cilk_sync;
      global = x + y + z;
      assert(__cilksan_error_count() == 1);
    ...
    {
      int x = 0, y = 0, z = 0;
      x = cilk_spawn read_x_bytes(&data[0], 2);
      y = cilk_spawn read_x_bytes(&data[2], 2);
      cilk_sync;
      z = cilk_spawn read_x_bytes(&data[0], 8); 
      write_x_bytes(&data[0], 8);
      cilk_sync;
    ...
    {
      int x = 0, y = 0, z = 0; 
      x = read_x_bytes(&data[0], 2);
      x += read_x_bytes(&data[2], 2);
      y = cilk_spawn read_x_bytes(&data[0], 8);
      z = cilk_spawn read_x_bytes(&data[0], 4);
      write_x_bytes(&data[0], 8);
      cilk_sync;
      global = x + y + z;
      assert(__cilksan_error_count() == 1);
